...
var levels = 8;
var level = 1;
var xy = [-1.999985881126867,0,-1.76877851023801,-0.00173889944794,-0.7428106660801,-0.126444300101,-0.77659226405,-0.136651039998,-0.17589070597346151,1.0866248318613803,0.2500098408374545,0,-1.7442271377036995,-0.00004589744356394797,0.3855769028905207,0.1771223560991527,-0.5615337270936567,-0.641923504258619]; // portal locations (packed)
var portalX = xy[0];
var portalY = xy[1];
...
function gameloop() {
	if (gamestate == "menu") {
		...
		contextM.fillText("zoom mult.: " + multiplier,400,500);
		contextM.fillText((Date.now()-startTime-timePaused)/1000 + "s",400,580);
